...
Shader "Shadero Customs/door"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_GhostFX_Smooth_1("_GhostFX_Smooth_1", Range(0, 1)) = 0.479
_GhostFX_ClipUp_1("_GhostFX_ClipUp_1", Range(0, 1)) = 0.414
_GhostFX_ClipDown_1("_GhostFX_ClipDown_1", Range(0, 1)) = 1
_GhostFX_ClipLeft_1("_GhostFX_ClipLeft_1", Range(0, 1)) = 1
_GhostFX_ClipRight_1("_GhostFX_ClipRight_1", Range(0, 1)) = 1
