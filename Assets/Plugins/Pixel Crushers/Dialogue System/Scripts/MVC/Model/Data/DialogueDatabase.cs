...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueDatabase : ScriptableObject
    {
        ...
        public Actor GetActor(string actorName)
        {
            ...
            SetupCaches();
            return actorNameCache.ContainsKey(actorName) ? actorNameCache[actorName] : null;
        }
        ...
        public Item GetItem(string itemName)
        {
            ...
            SetupCaches();
            return itemNameCache.ContainsKey(itemName) ? itemNameCache[itemName] : null;
        }
        ...
        public Location GetLocation(string locationName)
        {
            ...
            SetupCaches();
            return locationNameCache.ContainsKey(locationName) ? locationNameCache[locationName] : null;
        }
        ...
        public Variable GetVariable(string variableName)
        {
            ...
            SetupCaches();
            return variableNameCache.ContainsKey(variableName) ? variableNameCache[variableName] : null;
        }
        ...
        public Conversation GetConversation(string conversationTitle)
        {
            ...
            SetupCaches();
            return conversationTitleCache.ContainsKey(conversationTitle) ? conversationTitleCache[conversationTitle] : null;
        }
